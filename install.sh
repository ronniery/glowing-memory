...
printf "%b" "$YELLOW → Fetching docker-compose.yml from [ronniery/glowing-memory] repository...$NO_COLOR\n"
wget -q --show-progress --no-check-certificate https://raw.githubusercontent.com/ronniery/glowing-memory/master/docker-compose.yml
